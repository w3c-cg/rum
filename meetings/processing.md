# Processing Steps for Each Meeting
...
* Create a Google Doc for the meeting minutes ([example](https://docs.google.com/document/d/151gNC9yfZ7wAM2V-6N6biLpntmSXaK6O_0ae1MpLyWo/edit?usp=sharing)) into the [RUMCG Google Drive Folder](https://drive.google.com/drive/folders/1ocYBFw07q0kAcwZfwliysEwxs5C7_zmI)
  * Copy the AI summary notes into it, and review document for accuracy
  ...
  * Downloaded the meeting minutes in HTML (_File | Download | Web Page (.html, zipped)_) and put those files (HTML and any images) into the Github meeting folder (rename the HTML file to `index.html`)
  * Downloaded the meeting minutes in Markdown (_File | Download | Markdown (.md)_) and put those that as `index.md` into the Github meeting folder
